  ...
  <form action="/action_page.php">
    ...
    <div class="container col-lg-8 col-lg-offset-2">
      ...
      <div class="form-group">
        ...
        <span class="pwd pull-right">Forgot <a href="#">password?</a></span>
      </div>
    </div>
  </form>
  <div class="container col-lg-8 col-lg-offset-2 no_acc">
    <h3 class="register_link">Don't have an account? <a href="register.php">Click HERE</a> to register!</h3>
  </div>
