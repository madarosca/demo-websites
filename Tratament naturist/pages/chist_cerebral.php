...
<html lang="en-US">
    <head>
        ...
        <meta name="description" content="Tratamentele naturiste si remediile naturale au fost folosite mereu pentru diverse afectiuni. Tratamentul naturist pentru chist cerebral a functionat cu succes pentru pacientii nostri.">
        <meta name="keywords" content="chist cerebral, chist, tratament naturist, tratament chist, atac cerebral, tratament chist cerebral">
        <!-- Fonts -->
    ...
    <div class="main-wrapper row">
        ...
        <div id="intro" class="col-md-offset-2 col-md-8 text-center">
            <h3 class="b-title">Tratament naturist chist cerebral</h3>
            <br>
            <div>
