...
<html lang="en-US">
    <head>
        ...
        <meta name="description" content="Tratamentele naturiste si remediile naturale au fost folosite mereu pentru diverse afectiuni. Tratamentul naturist pentru cancer colorectal a functionat cu succes pentru pacientii nostri.">
        <meta name="keywords" content="cancer colorectal, cancer, tratament naturist, tratament cancer, cancer de colon, tratament cancer de colon">
        <!-- Fonts -->
    ...
    <div class="main-wrapper row">
        ...
        <div id="intro" class="col-md-offset-2 col-md-8 text-center">
            <h3 class="b-title">Tratament naturist cancer colorectal</h3>
            <br>
            <div>
