...
<html lang="en-US">
    <head>
        ...
        <meta name="description" content="Tratamentele naturiste si remediile naturale au fost folosite mereu pentru diverse afectiuni. Tratamentul naturist pentru noduli tiroidieni a functionat cu succes pentru pacientii nostri.">
        <meta name="keywords" content="noduli tiroidieni, tratament naturist, tratament noduli tiroidieni, boli tiroida, tiroida, hormoni, dereglare hormonala">
        <!-- Fonts -->
    ...
    <div class="main-wrapper row">
        ...
        <div id="intro" class="col-md-offset-2 col-md-8 text-center">
            <h3 class="b-title">Tratament naturist noduli tiroidieni</h3>
            <br>
            <div>
