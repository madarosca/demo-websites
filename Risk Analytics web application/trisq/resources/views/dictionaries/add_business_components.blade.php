...
@section('title', 'Trisq Add Business Component')
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div id="div_id_order_seq" class="form-group col-lg-12">
                            <div class="form-group">
                                <label for="id_order_seq" class="col-md-1 control-label">Order seq<span class="asteriskField">*</span></label>
                                <div class="col-lg-8">
                                    <input type="number" class="numberinput" id="order_seq" step="0.01" name="order_seq" required/>
                                </div>
                            </div>
                            </div>
                        </div>
