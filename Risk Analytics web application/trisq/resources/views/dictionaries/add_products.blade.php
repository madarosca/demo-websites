...
@section('title', 'Trisq Add Product')
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="number" class="numberinput" id="volume" step="0.01" name="volume" required/>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="number" class="numberinput" id="vbw" step="0.01" name="vbw" required/>
                                </div>
                            </div>
                            </div>
                        </div>
