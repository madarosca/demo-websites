...
@section('title', 'Trisq Edit Risk Type')
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control textinput" id="code" maxlength="200" name="code" value="{{ $risk_type->name }}" required/>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control textinput" id="name" maxlength="200" name="name" value="{{ $risk_type->name }}" required/>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control textinput" id="category" maxlength="200" name="category" value="{{ $risk_type->category }}" required/>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control textinput" id="description" maxlength="200" name="description" value="{{ $risk_type->description }}" required/>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control textinput" id="calculation_type" maxlength="200" name="calculation_type" value="{{ $risk_type->calculation_type }}" required/>
                                </div>
                            </div>
                            </div>
                        </div>
